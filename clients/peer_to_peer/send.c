...
static void send_message(app_data_t* app, pn_link_t *sender) {
  ...
  const char * str_100 = "0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789";
  ...
  /*fprintf ( stderr, "MDEBUG pn_data_put_int ID %d\n", app->sent ); */
  /*pn_data_put_map(body);*/
  pn_data_enter(body);
  pn_data_put_string(body, pn_bytes(100, str_100));
  /*pn_data_put_string(body, pn_bytes(13, str_hello));*/
  ...
  /* fprintf ( stderr, "MDEBUG send message %d\n", app->sent ); */
}
...
int main(int argc, char **argv) {
  ...
  app.message_count = (argc > 4) ? atoi(argv[4]) : 5;
